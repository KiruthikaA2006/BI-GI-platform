  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#e4dac9] text-stone-900 selection:bg-blue-500">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <Header title="Manager Profile" subtitle="Manager Login Scope: Account & Department Profile Settings" />

        <main className="p-6 space-y-6 max-w-[1600px] mx-auto w-full">
          <div className="bg-white border border-stone-200 p-6 rounded-3xl shadow-sm space-y-1">
            <span className="text-[10px] font-extrabold uppercase text-blue-600">Manager Scope: Profile</span>
            <h1 className="text-2xl font-black text-stone-900">Manager Profile Settings</h1>
          </div>
          ...
          <form onSubmit={handleSave} className="bg-white border border-stone-200 p-6 rounded-3xl space-y-4 max-w-xl shadow-sm">
            {saved && (
              <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-2xl flex items-center gap-2 text-xs text-emerald-800 font-bold">
                ...
                <span>Manager profile saved successfully!</span>
              </div>
            )}
